...
namespace LeagueActivityBot.Notifications.OnSoloGameStarted
{
    public class OnSoloGameStartedMessageBuilder
    {
        ...
        {
            var sb = new StringBuilder($"{notification.Summoner.GetName()} totally doesn't give a fuck about his friends and started to play solo {QueueType.GetQueueTypeById(notification.QueueTypeId)}");
